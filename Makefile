...
#all: son/son sip/sip server/app_simple_server server/app_stress_server  
...
client/app_simple_client: client/app_simple_client.c common/seg.o client/stcp_client.o topology/topology.o 
	gcc -Wall -pedantic -std=c99 -g -pthread -lrt client/app_simple_client.c common/seg.o client/stcp_client.o topology/topology.o -o client/app_simple_client 
client/app_stress_client: client/app_stress_client.c common/seg.o client/stcp_client.o topology/topology.o 
	gcc -Wall -pedantic -std=c99 -g -lrt -pthread client/app_stress_client.c common/seg.o client/stcp_client.o topology/topology.o -o client/app_stress_client 
server/app_simple_server: server/app_simple_server.c common/seg.o server/stcp_server.o topology/topology.o server/stcp_buffer.o
	gcc -Wall -pedantic -std=c99 -g -lrt -pthread server/app_simple_server.c server/stcp_buffer.o common/seg.o server/stcp_server.o topology/topology.o -o server/app_simple_server
server/app_stress_server: server/app_stress_server.c common/seg.o server/stcp_server.o topology/topology.o server/stcp_buffer.o
	gcc -Wall -pedantic -std=c99 -g -pthread server/app_stress_server.c server/stcp_buffer.o common/seg.o server/stcp_server.o topology/topology.o -o server/app_stress_server
...
client/stcp_client.o: client/stcp_client.c client/stcp_client.h 
	gcc -pthread -lrt -g -c client/stcp_client.c -o client/stcp_client.o
server/stcp_server.o: server/stcp_server.c server/stcp_server.h server/stcp_buffer.o
	gcc -pthread -g -c server/stcp_server.c -o server/stcp_server.o
server/stcp_buffer.o: server/stcp_buffer.c server/stcp_buffer.h
	gcc -pthread -g -c server/stcp_buffer.c -o server/stcp_buffer.o
